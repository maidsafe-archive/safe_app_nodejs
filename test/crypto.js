...
describe('Crypto Smoke Test', () => {
  it('properly sha3 hashes strings', () => lib.sha3_hash('test').then((resp) => {
    should(resp.toString())
        .equal(Buffer('36f028580bb02cc8272a9a020f4200e346e276ae664e45ee80745574e2f5ab80', 'hex').toString());
  }));

  it('properly sha3 hashes buffers', () => lib.sha3_hash(new Buffer('test a different value in a buffer')).then((resp) => {
    should(resp.toString())
